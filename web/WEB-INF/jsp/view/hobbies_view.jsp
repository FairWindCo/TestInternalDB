        ...
        <script>
            $(document).ready(function() {
                ...
                $('#ExpenseTableContainer').jtable({
                    title: '<c:message code="label.hobbie.table.label"/>',
                    ...
                    actions: {
                        ...
                        listAction: '${pageContext.request.contextPath}/hobbies/listedit',
                        createAction: '${pageContext.request.contextPath}/hobbies/addfiletype',
                        updateAction: '${pageContext.request.contextPath}/hobbies/updatefiletype',
                        deleteAction: '${pageContext.request.contextPath}/hobbies/deletefiletype'
                    },
                    fields: {
                        hobbieId: {
                            title: 'ID',
                        ...
                        hobbieName: {
                            title: '<c:message code="label.hobbie.table.col_title.name"/>',
                            width: '70%',
                        },
                        key1c: {
