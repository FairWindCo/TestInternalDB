...
// Grab the files and set them to our variable
    ...
    $('#ExpenseTableContainer').jtable({
      title: '<c:message code="label.workertables"/>',
      ...
      actions: {
        listAction: '${pageContext.request.contextPath}/person/listWorkers',
        <sec:authorize ifAnyGranted="ROLE_PERSONAL_ADD">
        createAction: '${pageContext.request.contextPath}/person/addWorker',
        </sec:authorize>
        <sec:authorize ifAnyGranted="ROLE_PERSONAL_EDIT">
      ...
      fields: {
        ...
        */
        ...
        <sec:authorize ifAnyGranted="ROLE_PERSONAL_VIEW,ROLE_PERSONAL_EDIT">
        printDetail: {
          title: '',
          width: '1%',
          sorting: false,
